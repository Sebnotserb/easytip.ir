  ...
  return (
    <main className="min-h-screen">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center md:text-right">
            <div className="inline-block bg-accent-light text-accent text-xs font-bold px-3 py-1.5 rounded-full mb-5">
              برای همه کافه‌ها رایگانه
            </div>
            <h1 className="text-4xl md:text-5xl font-extrabold text-dark mb-5 leading-[1.3]">
              دریافت انعام رو
              <br />
              <span className="text-primary">آسون</span> کنید.
            </h1>
            <p className="text-lg text-muted mb-8 max-w-lg leading-relaxed md:mx-0 mx-auto">
              ...
              <div className="w-[280px] md:w-[300px] bg-dark rounded-[3rem] p-3 shadow-card-lg">
                <div className="bg-white rounded-[2.3rem] overflow-hidden">
                  ...
                  <div className="bg-secondary px-6 py-3 flex items-center justify-between">
                    ...
                    <div className="text-[10px] text-muted font-bold">۱۲:۳۰</div>
                  </div>
                  {/* Mock tipping page */}
                  <div className="px-5 py-6">
                    ...
                    <p className="text-center font-extrabold text-dark text-sm mb-1">کافه لمیز</p>
                    <p className="text-center text-[10px] text-muted mb-4">خوشحال می‌شیم حمایتمون کنید</p>
                    {/* Amount buttons */}
                    <div className="grid grid-cols-2 gap-2 mb-3">
                      <div className="bg-gray-50 rounded-xl py-2.5 text-center text-xs font-bold text-dark border border-gray-100">۵۰,۰۰۰</div>
                      <div className="bg-cta rounded-xl py-2.5 text-center text-xs font-bold text-white shadow-sm">۱۵۰,۰۰۰</div>
                      <div className="bg-gray-50 rounded-xl py-2.5 text-center text-xs font-bold text-dark border border-gray-100">۵۰۰,۰۰۰</div>
                      <div className="bg-gray-50 rounded-xl py-2.5 text-center text-xs font-bold text-dark border border-gray-100">۱,۰۰۰,۰۰۰</div>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-1 mt-2">
                      ...
                      <span className="text-[8px] text-muted/60">پرداخت امن</span>
                    </div>
                  </div>
                </div>
              </div>
              {/* Floating badge */}
              <div className="absolute -bottom-3 -right-4 bg-white rounded-2xl shadow-card-lg px-4 py-2.5 border border-gray-100">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-[10px] text-muted">انعام دریافت شد</p>
                    <p className="text-xs font-extrabold text-dark">۱۵۰,۰۰۰ تومان</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-8 px-4 border-y border-gray-100 bg-white">
        <div className="max-w-4xl mx-auto flex flex-wrap items-center justify-center gap-8 md:gap-16">
          <div className="text-center">
            <p className="text-2xl font-extrabold text-dark">۵٪</p>
            <p className="text-xs text-muted mt-1">تنها کارمزد</p>
          </div>
          <div className="w-px h-8 bg-gray-200 hidden md:block" />
          <div className="text-center">
            <p className="text-2xl font-extrabold text-dark">۳۰ ثانیه</p>
            <p className="text-xs text-muted mt-1">از اسکن تا پرداخت</p>
          </div>
          <div className="w-px h-8 bg-gray-200 hidden md:block" />
          <div className="text-center">
            <p className="text-2xl font-extrabold text-dark">بدون اپ</p>
            <p className="text-xs text-muted mt-1">بدون ثبت‌نام مشتری</p>
          </div>
          <div className="w-px h-8 bg-gray-200 hidden md:block" />
          <div className="text-center">
            <p className="text-2xl font-extrabold text-dark">رایگان</p>
            <p className="text-xs text-muted mt-1">بدون هزینه ماهانه</p>
          </div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="py-16 md:py-24 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-3">
            فراتر از یه انعام ساده
          </h2>
          <p className="text-muted text-center mb-14 max-w-lg mx-auto leading-relaxed">
            یه تجربه مدرن که مشتری‌ها راحت قدردانی کنن و بازخوردشون رو به اشتراک بذارن.
            ...
            {[
              {
                step: "۱",
                title: "اسکن QR کد",
                desc: "مشتری دوربین گوشی رو روی QR کد میز می‌گیره — بدون نصب اپ، بدون ثبت‌نام.",
                icon: (
              ...
              },
              {
                step: "۲",
                title: "انتخاب مبلغ",
                desc: "مبلغ دلخواه رو انتخاب می‌کنه و اگه بخواد، نظر و امتیاز هم ثبت می‌کنه.",
                icon: (
                  <svg className="w-8 h-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              },
              {
                step: "۳",
                title: "پرداخت امن",
                desc: "پرداخت از درگاه امن زرین‌پال انجام می‌شه و مبلغ مستقیم به کیف‌پول کافه می‌رسه.",
                icon: (
                  <svg className="w-8 h-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <section className="py-16 md:py-24 px-4 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-3">
            با ایزی‌تیپ یه سطح بالاتر برید
          </h2>
          <p className="text-muted text-center mb-14 max-w-md mx-auto">
            ابزارهایی که مدیریت انعام رو حرفه‌ای و لذت‌بخش می‌کنن
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              {
                title: "بدون هزینه اولیه",
                desc: "بدون هزینه عضویت. تنها ۵٪ کارمزد روی هر تراکنش — اون هم از مشتری، نه از شما.",
                icon: (
              ...
              {
                title: "مشتری چیزی نصب نمی‌کنه",
                desc: "مشتری فقط اسکن می‌کنه و پرداخت می‌کنه. بدون دانلود، بدون ثبت‌نام — زیر ۳۰ ثانیه.",
                icon: (
                  <svg className="w-6 h-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              },
              {
                ...
                desc: "آمار لحظه‌ای، نمودار درآمد، بازخورد مشتری‌ها و مدیریت مالی — همه در یه پنل.",
                icon: (
                  <svg className="w-6 h-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              {
                title: "امن و شفاف",
                desc: "پرداخت از درگاه امن زرین‌پال انجام می‌شه. کارمزد کاملاً شفاف و قبل از پرداخت نمایش داده می‌شه.",
                icon: (
                  <svg className="w-6 h-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
                  </svg>
              ...
              {
                title: "QR کد اختصاصی",
                desc: "هر کافه QR کد اختصاصی خودش رو داره. دانلودش کنید، چاپش کنید و بذارید روی میزها.",
                icon: (
                  <svg className="w-6 h-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.875c0-.621.504-1.125 1.125-1.125h4.5c.621 0 1.125.504 1.125 1.125v4.5c0 .621-.504 1.125-1.125 1.125h-4.5A1.125 1.125 0 013.75 9.375v-4.5zM3.75 14.625c0-.621.504-1.125 1.125-1.125h4.5c.621 0 1.125.504 1.125 1.125v4.5c0 .621-.504 1.125-1.125 1.125h-4.5a1.125 1.125 0 01-1.125-1.125v-4.5zM13.5 4.875c0-.621.504-1.125 1.125-1.125h4.5c.621 0 1.125.504 1.125 1.125v4.5c0 .621-.504 1.125-1.125 1.125h-4.5A1.125 1.125 0 0113.5 9.375v-4.5z" />
                  </svg>
              ...
              {
                title: "نظرات و امتیاز مشتری",
                desc: "مشتری‌ها امتیاز و نظر ثبت می‌کنن — بازخوردی که واقعاً به بهتر شدن کمک می‌کنه.",
                icon: (
                  <svg className="w-6 h-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="max-w-lg mx-auto text-center">
          <h2 className="text-3xl font-extrabold mb-3">ایزی‌تیپ برای همه رایگانه</h2>
          <p className="text-muted mb-10">
            هیچ هزینه پنهانی وجود نداره — مدل درآمدی ما ساده و شفافه
          </p>
          <div className="bg-white rounded-3xl p-8 shadow-card border border-gray-100">
            <div className="text-5xl font-extrabold text-cta mb-2">
              ۵<span className="text-2xl">٪</span>
            </div>
            <p className="text-muted mb-6">
              کارمزد خدمات (از مشتری — نه از کافه)
            </p>
            <hr className="my-6 border-gray-100" />
            <ul className="text-right space-y-3 text-muted text-sm">
              {[
      ...
      <section className="py-16 md:py-24 px-4 bg-gray-50">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-12">همه سؤالاتتون، یه‌جا جواب داده شده</h2>
          <div className="space-y-4">
            {[
              {
                q: "مشتری نیاز به نصب اپلیکیشن داره؟",
                a: "خیر. مشتری فقط QR کد رو با دوربین گوشی اسکن می‌کنه و صفحه پرداخت در مرورگر باز می‌شه. نیازی به نصب هیچ اپلیکیشنی نیست.",
              },
              {
                q: "پول انعام کِی به حسابم واریز می‌شه؟",
                a: "انعام بلافاصله به کیف‌پول شما در پنل ایزی‌تیپ اضافه می‌شه. برداشت به حساب بانکی معمولاً تا ۷۲ ساعت کاری پردازش می‌شه.",
              },
              {
                q: "کارمزد ۵٪ از کی گرفته می‌شه؟",
                a: "کارمزد از مشتری گرفته می‌شه، نه از کافه. مثلاً اگه مشتری ۱۰۰ هزار تومان انعام بده، ۵ هزار تومان کارمزد روش اضافه می‌شه و مشتری ۱۰۵ هزار تومان پرداخت می‌کنه. کل ۱۰۰ هزار تومان به شما می‌رسه.",
              },
              {
                q: "اگه مشتری اشتباهی پرداخت کنه چی؟",
                a: "از طریق بخش پشتیبانی در داشبورد تیکت بزنید تا بررسی کنیم. در صورت تایید، مبلغ قابل بازگشته.",
              },
              {
                q: "آیا هزینه ماهانه یا سالانه دارید؟",
                a: "خیر. ایزی‌تیپ کاملاً رایگانه. تنها هزینه همون ۵٪ کارمزد هر تراکنشه که مشتری پرداخت می‌کنه.",
              },
            ].map((faq, i) => (
              <details
                key={i}
      ...
      <section className="py-16 md:py-24 px-4 bg-gradient-to-b from-white to-secondary text-center">
        <h2 className="text-3xl font-extrabold mb-3">وقتشه انعام دیجیتال رو شروع کنید</h2>
        <p className="text-muted mb-8 max-w-md mx-auto">
          ثبت‌نام رایگانه، راه‌اندازی ۲ دقیقه‌ایه و از همون روز اول نتیجه‌شو می‌بینید
        </p>
        <Link
          href="/auth/register"
      ...
      <footer className="bg-dark text-white py-10 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-sm">
            پلتفرم انعام دیجیتال برای کافه‌ها و رستوران‌ها
          </p>
          ...
          <p className="text-gray-500 text-xs">
            © ۱۴۰۴ ایزی‌تیپ — تمامی حقوق محفوظ است
          </p>
        </div>
      </footer>
    </main>
